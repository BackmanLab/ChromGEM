...
In this folder, we explain the ChromGEM codes and demonstrate ChromGEM profiling of label performance using BrdU and EdU labels as demos. Scripts are given for reproducibility but the files generated by each layer are provided for added convenience.
