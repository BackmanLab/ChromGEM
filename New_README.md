...
In this folder, we explain the ChromGEM codes and demonstrate ChromGEM profiling of label performance in chromatin using BrdU and EdU labels as examples. Scripts are given for reproducibility but the files generated by each layer are provided for added convenience.
...
*For more about ChromGEM temperature setting, see "Conceptual Notes".
